...
public enum ErrorCode {
    ...
    INVALID_DOB(1008, "Your age must be at least {min} and {max}", HttpStatus.BAD_REQUEST),
    ...
    INTERNAL_ERROR(1012, "Internal server error", HttpStatus.INTERNAL_SERVER_ERROR)
    ;
